class Sysinfo {
  ...
  updateDate() {
    ...
    document.querySelector(
      "#mod_sysinfo > div:first-child > h1"
    ).innerHTML = time.getFullYear();
    ...
    let timeToNewDay =
      (23 - time.getHours()) * 3600000 + (59 - time.getMinutes()) * 60000;
    setTimeout(() => {
      this.updateDate();
    }, timeToNewDay);
  }
  updateUptime() {
    ...
    if (uptime.minutes.toString().length !== 2)
      uptime.minutes = "0" + uptime.minutes;
